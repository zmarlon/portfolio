    ...
    <main>
      <div className="App row">
        ...
        <div className="col-xl SecondColumn">
          ...
          <Project platform="Gitea" language="C++ / C#" name="PD Engine" description="A C++ game engine that uses Vulkan and has a NET runtime embedded." link="https://www.gitea.com/zmarlon/PDEngine" thumbnail={pdEngine}></Project>
          ...
          <Project platform="Github" language="JavaScript" name="Portfolio" description="My portfolio using React and Bootstrap." thumbnail={portfolio}></Project>
